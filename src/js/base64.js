...
export function byteLength(b64) {
  ...
  return ((validLen + placeHoldersLen) * 0.75) - placeHoldersLen;
}

function pbyteLength(b64, validLen, placeHoldersLen) {
  return ((validLen + placeHoldersLen) * 0.75) - placeHoldersLen;
}
...
export function toByteArray(b64) {
  ...
  const arr = new Arr(pbyteLength(b64, validLen, placeHoldersLen));
